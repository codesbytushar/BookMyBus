...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="{{ asset('bookingTheme/vendors/typicons/typicons.css') }}">
    ...
    <link rel="stylesheet" href="{{ asset('bookingTheme/vendors/datatables.net-bs4/dataTables.bootstrap4.css') }}">
    <link rel="stylesheet" type="text/css" href="{{ asset('bookingTheme/js/select.dataTables.min.css') }}">
  ...
  <body class="with-welcome-text">
        ...
        <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-start">
          ...
          <div>
            <a class="navbar-brand brand-logo" href="index.html">
              <img src="{{ asset('bookingTheme/images/logo.svg') }}" alt="logo" />
            </a>
            <a class="navbar-brand brand-logo-mini" href="index.html">
              <img src="{{ asset('bookingTheme/images/logo-mini.svg') }}" alt="logo" />
            </a>
          </div>
        </div>
          ...
          <ul class="navbar-nav ms-auto">
            ...
            <li class="nav-item dropdown">
              ...
              <div class="dropdown-menu dropdown-menu-right navbar-dropdown preview-list pb-0" aria-labelledby="countDropdown">
                ...
                <a class="dropdown-item preview-item">
                  <div class="preview-thumbnail">
                    <img src="{{ asset('bookingTheme/images/faces/face10.jpg') }}" alt="image" class="img-sm profile-pic">
                  </div>
                  <div class="preview-item-content flex-grow py-2">
                ...
                <a class="dropdown-item preview-item">
                  <div class="preview-thumbnail">
                    <img src="{{ asset('bookingTheme/images/faces/face12.jpg') }}" alt="image" class="img-sm profile-pic">
                  </div>
                  <div class="preview-item-content flex-grow py-2">
                ...
                <a class="dropdown-item preview-item">
                  <div class="preview-thumbnail">
                    <img src="{{ asset('bookingTheme/images/faces/face1.jpg') }}" alt="image" class="img-sm profile-pic">
                  </div>
                  <div class="preview-item-content flex-grow py-2">
            ...
            <li class="nav-item dropdown d-none d-lg-block user-dropdown">
              <a class="nav-link" id="UserDropdown" href="#" data-bs-toggle="dropdown" aria-expanded="false">
                <img class="img-xs rounded-circle" src="{{ asset('bookingTheme/images/faces/face8.jpg') }}" alt="Profile image"> </a>
              <div class="dropdown-menu dropdown-menu-right navbar-dropdown" aria-labelledby="UserDropdown">
                <div class="dropdown-header text-center">
                  <img class="img-md rounded-circle" src="{{ asset('bookingTheme/images/faces/face8.jpg') }}" alt="Profile image">
                                    ...
                                    <table class="table select-table">
                                      ...
                                      <tbody>
                                        <tr>
                                          ...
                                          <td>
                                            <div class="d-flex ">
                                              <img src="{{ asset('bookingtheme/images/faces/face1.jpg') }}" alt="">
                                              <div>
                                        ...
                                        <tr>
                                          ...
                                          <td>
                                            <div class="d-flex">
                                              <img src="{{ asset('bookingTheme/images/faces/face2.jpg') }}" alt="">
                                              <div>
                                                <h6>Laura Brooks</h6>
                                                <p>Head admin</p>
                                              </div>
                                        ...
                                        <tr>
                                          ...
                                          <td>
                                            <div class="d-flex">
                                              <img src="{{ asset('bookingTheme/images/faces/face3.jpg') }}" alt="">
                                              <div>
                                                <h6>Wayne Murphy</h6>
                                                <p>Head admin</p>
                                              </div>
                                        ...
                                        <tr>
                                          ...
                                          <td>
                                            <div class="d-flex">
                                              <img src="{{ asset('bookingTheme/images/faces/face4.jpg') }}" alt="">
                                              <div>
                                        ...
                                        <tr>
                                          ...
                                          <td>
                                            <div class="d-flex">
                                              <img src="{{ asset('bookingTheme/images/faces/face5.jpg') }}" alt="">
                                              <div>
    ...
    <script src="{{ asset('bookingTheme/vendors/chart.js/chart.umd.js') }}"></script>
    <script src="{{ asset('bookingTheme/vendors/progressbar.js/progressbar.min.js') }}"></script>
    ...
    <script src="{{ asset('bookingTheme/js/todolist.js') }}"></script>
    <!-- endinject -->
    <!-- Custom js for this page-->
    <script src="{{ asset('bookingTheme/js/jquery.cookie.js') }}" type="text/javascript"></script>
    <script src="{{ asset('bookingTheme/js/dashboard.js') }}"></script>
